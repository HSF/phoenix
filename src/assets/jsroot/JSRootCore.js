...
(function( factory ) {
   if ( typeof define === "function" && define.amd ) {
      ...
      var jsroot = factory({}),
          dir = jsroot.source_dir + "assets/jsroot/",
   ...
   if ((typeof document !== "undefined") && (typeof window !== "undefined")) {
      ...
      for (var n = 0; n < scripts.length; ++n) {
         ...
         var pos = scripts[n].src.indexOf("assets/jsroot/JSRootCore.");
         if (pos<0) continue;

         JSROOT.source_dir = scripts[n].src.substr(0, pos);
         JSROOT.source_min = scripts[n].src.indexOf("assets/jsroot/JSRootCore.min.js") >= 0;
    ...
    * <script type="text/javascript" src="assets/jsroot/JSRootCore.js"></script>
   ...
   JSROOT.loadScript = function(urllist, callback, debugout, from_previous) {
      ...
      if (filename.indexOf('&&&assets/jsroot/')===0) {
         isrootjs = true;
         ...
         isrootjs = true;
         filename = filename.slice(3);
         if ((filename.indexOf("assets/jsroot/style/")==0) && JSROOT.source_min &&
      ...
      if (JSROOT.nodejs) {
         if ((filename.indexOf("assets/jsroot/")===0) && (filename.indexOf(".js")>0)) {
   ...
   JSROOT.AssertPrerequisites = function(kind, callback, debugout) {
      ...
      if ((kind.indexOf('io;')>=0) || (kind.indexOf('tree;')>=0))
         if (jsroot.sources.indexOf("io")<0) {
            mainfiles += "&&&assets/jsroot/rawinflate.min.js;" +
                         "$$$assets/jsroot/JSRootIOEvolution" + ext + ".js;";
      ...
      if ((kind.indexOf('math;')>=0) || (kind.indexOf('tree;')>=0) || (kind.indexOf('more2d;')>=0))
         if (jsroot.sources.indexOf("math")<0) {
            mainfiles += '$$$assets/jsroot/JSRootMath' + ext + ".js;";
            modules.push('JSRootMath');
         }

      if (kind.indexOf('tree;')>=0)
         if (jsroot.sources.indexOf("tree")<0) {
            mainfiles += "$$$assets/jsroot/JSRootTree" + ext + ".js;";
      ...
      if ((kind.indexOf('2d;')>=0) || (kind.indexOf('v6;')>=0) || (kind.indexOf('v7;')>=0) ||
          ...
          if (!use_require && (typeof d3 != 'object') && (jsroot._test_d3_ === undefined)) {
             mainfiles += use_bower ? '###d3/d3.min.js;' : '&&&assets/jsroot/d3.min.js;';
             jsroot._test_d3_ = null;
         }
         if (jsroot.sources.indexOf("2d") < 0) {
            modules.push('JSRootPainter');
            mainfiles += '$$$assets/jsroot/JSRootPainter' + ext + ".js;";
            extrafiles += '$$$assets/jsroot/style/JSRootPainter' + ext + '.css;';
         }
         if ((jsroot.sources.indexOf("v6") < 0) && (kind.indexOf('v7;') < 0)) {
            mainfiles += '$$$assets/jsroot/JSRootPainter.v6' + ext + ".js;";
      ...
      if (((kind.indexOf('hist;')>=0) || (kind.indexOf('hist3d;')>=0)) && (jsroot.sources.indexOf("hist")<0)) {
         mainfiles += '$$$assets/jsroot/JSRootPainter.hist' + ext + ".js;";
      ...
      if ((kind.indexOf("geom;")>=0) && (jsroot.sources.indexOf("geom")<0)) {
         mainfiles += "$$$assets/jsroot/ThreeCSG" + ext + ".js;" +
                      "$$$assets/jsroot/JSRootGeoBase" + ext + ".js;" +
                      "$$$assets/jsroot/JSRootGeoPainter" + ext + ".js;";
         extrafiles += "$$$assets/jsroot/style/JSRootGeoPainter" + ext + ".css;";
      ...
      if (need_jquery && !jsroot.load_jquery) {
         ...
         if (has_jq && typeof $.ui != 'undefined') {
            ...
            extrafiles += '$$$assets/jsroot/style/jquery-ui' + ext + '.css;';
         }

         if (jsroot.touches) {
            lst_jq += use_bower ? '###jqueryui-touch-punch/jquery.ui.touch-punch.min.js;' : '$$$assets/jsroot/touch-punch.min.js;';
